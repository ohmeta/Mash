...
Command::Command()
{
    ...
    addAvailableOption("barcodeformat", Option(Option::Integer, "F", "Sketch", "barcode format(1 | 2), format 1 is <id barcode>, fromat 2 is <id#barcode/1>", ""));
